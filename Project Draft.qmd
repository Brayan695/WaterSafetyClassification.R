...
We set our seed to 123 for reproducibility. We split “final_data” into training and testing sets using “createDataPartition”. This makes our model use 80% for training and the remaining 20% for testing.  The split is stratified based on the response variable, ensuring the equal distribution of classes in both sets.
